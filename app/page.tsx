  ...
  return (
    ...
    >
      <Link
        ...
        // The margin-bottom is adjusted for responsiveness.
        className="inline-block group cursor-pointer mb-10 sm:mb-12 md:mb-16"
      >
        <div
          // The main button container with all styling and animations.
