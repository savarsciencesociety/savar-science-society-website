        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                <Button
                asChild
                // The outer <Button> component is now just a shell.
                // The inner <Link> will have all the styling and act as the button.
              >
                <Link
                  href="/register"
                  style={{
                ...
                >
                  {/* This text is invisible and acts as a placeholder for the button's size */}
                  Launch Registration
              
                  {/* First text layer, visible by default and slides up on hover */}
                  ...
                  {/* Second text layer, slides in from bottom on hover */}
