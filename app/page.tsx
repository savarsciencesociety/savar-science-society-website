...
// Replace the OLYMPIAD_PHOTOS constant with working placeholder images
const OLYMPIAD_PHOTOS = [
  {
    ...
    googlePhotosUrl: "https://photos.app.goo.gl/a452mvDvugnS1hM49",
  },
  {
    id: 2,
    url: "/placeholder.svg?height=400&width=600",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900">
      ...
      >
        <div className="container mx-auto px-4">
          <PhotoGallery
            photos={OLYMPIAD_PHOTOS}
            albumUrl="https://photos.app.goo.gl/a452mvDvugnS1hM49"
            title="Olympiad 2.0 Memories"
            description="Relive the excitement, dedication, and achievements from our previous olympiad. These moments capture the spirit of learning and excellence."
          />
        </div>
      </section>
