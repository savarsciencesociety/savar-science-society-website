...
const MergedLaunchButton = () => {
  return (
    // The main container for the button's visuals and reflection.
    // It's a div, so it inherits the link behavior from its parent.
    <div
      style={{
        WebkitBoxReflect: 'below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.2))',
      }}
      // The 'group' class allows the hover effects to work when the parent <a> tag is hovered.
      className="inline-block group cursor-pointer"
    >
      <div
        // This inner div contains all the styling, layers, and animations.
        className="px-10 py-6 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-purple-500/25 shadow-cyan-500/25 uppercase font-serif tracking-widest relative overflow-hidden text-transparent z-10 after:absolute after:rounded-full after:bg-cyan-200 after:h-[85%] after:w-[95%] after:left-1/2 after:top-1/2 after:-translate-x-1/2 after:-translate-y-1/2 hover:saturate-[1.15] active:saturate-[1.4] transform group-hover:scale-105 transition-all duration-300 border-0"
      >
        {/* Visually hidden span to correctly size the button. */}
        <span className="opacity-0">Launch Registration</span>
        
        {/* "Launch" Text Layer */}
        <p
          className="absolute z-40 font-semibold bg-gradient-to-r from-cyan-500 to-purple-500 bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 h-full w-full transition-all duration-300 -translate-y-1/2 group-hover:-translate-y-[150%] tracking-widest flex items-center justify-center"
        >
          Launch
        </p>
        
        {/* "Registration" Text Layer */}
        <p
          className="absolute z-40 top-1/2 left-1/2 bg-gradient-to-r from-cyan-700 to-purple-700 bg-clip-text text-transparent -translate-x-1/2 h-full w-full transition-all duration-300 translate-y-[150%] group-hover:-translate-y-1/2 tracking-widest font-extrabold flex items-center justify-center"
        >
          Registration
        </p>
        ...
        >
          <defs>
            <linearGradient id="merged-button-grad-2" y2="100%" x2="50%" y1="0%" x1="50%">
              <stop offset="0%" stopOpacity="1" stopColor="hsl(187, 96%, 43%)"></stop>
              <stop offset="100%" stopOpacity="1" stopColor="hsl(255, 91%, 66%)"></stop>
            </linearGradient>
          </defs>
          <g transform="matrix(1,0,0,1,0,-91.0877685546875)" fill="url(#merged-button-grad-2)">
