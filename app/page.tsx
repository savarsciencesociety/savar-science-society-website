        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
                <Button
                  asChild
                  className="relative overflow-hidden rounded-full px-10 py-6 text-lg font-serif uppercase tracking-widest shadow-xl bg-gradient-to-r from-red-500 to-orange-500 text-transparent cursor-pointer group hover:saturate-[1.15] active:saturate-[1.4] transition-all duration-300 border-0"
                  style={{
                    WebkitBoxReflect:
                      "below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.4))",
                  }}
                >
                  <Link href="/register" className="z-10 w-full h-full flex items-center justify-center">
                    <span className="absolute z-40 font-bold bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent top-1/2 left-1/2 -translate-x-1/2 transition-all duration-300 -translate-y-[30%] group-hover:-translate-y-full">
                      Registration Now
                    </span>
                    <span className="absolute z-40 top-1/2 left-1/2 bg-gradient-to-r from-red-700 to-orange-700 bg-clip-text text-transparent -translate-x-1/2 translate-y-full transition-all duration-300 group-hover:-translate-y-[40%] font-extrabold">
                      Click To Go
                    </span>
