                  ...
                  <div className="relative flex justify-center items-center my-10">
                    <Link href="/register">
                      <button
                        ...
                        className="relative px-14 py-5 rounded-full bg-gradient-to-r from-red-500 to-orange-500 shadow-2xl text-transparent font-extrabold text-lg tracking-widest uppercase overflow-hidden group cursor-pointer transition-all duration-300"
                        style={{
                          WebkitBoxReflect:
                            "below 0px linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,0.3))",
                        }}
                      >
                        {/* Text Swap */}
                        <span className="absolute inset-0 flex items-center justify-center z-10 bg-gradient-to-r from-red-500 to-orange-500 bg-clip-text text-transparent transition-all duration-300 ease-in-out translate-y-0 group-hover:-translate-y-full">
                          {hovered ? "CLICK TO GO" : "REGISTER NOW"}
                        </span>
              
                        {/* Floating Rocket */}
                        <span className="absolute left-5 top-1/2 -translate-y-1/2 z-20 animate-bounce text-white">
                          <Rocket size={20} />
                        </span>
              
                        {/* Wave animation SVG */}
                        <svg
                          className="absolute w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-[30%] z-0 opacity-70 group-hover:scale-95 transition-transform duration-500"
