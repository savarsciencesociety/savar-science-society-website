...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 overflow-x-hidden">
      ...
      {/* Header */}
      <header className="fixed top-0 left-0 right-0 z-40 bg-white/10 dark:bg-slate-900/10 backdrop-blur-xl border-b border-white/20 dark:border-slate-700/20">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link
              href="/"
              className="flex items-center gap-3 hover:opacity-90 transition-all duration-500 transform hover:scale-105 group"
            >
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full blur-lg opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
                <Image
      ...
      >
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <Badge className="mb-6 bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-3 text-sm font-medium animate-pulse-glow shadow-lg shadow-cyan-500/25">
              <Sparkles className="mr-2 h-4 w-4" />
              Registration Open for Olympiad 3.0
            </Badge>

            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-tight">
              <span className="block bg-gradient-to-r from-slate-800 via-cyan-600 to-purple-600 dark:from-white dark:via-cyan-400 dark:to-purple-400 bg-clip-text text-transparent animate-gradient-x">
                MATH & SCIENCE
              </span>
              <span className="block bg-gradient-to-r from-purple-600 via-pink-500 to-cyan-500 bg-clip-text text-transparent animate-gradient-x-reverse">
                OLYMPIAD 3.0
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Button
                asChild
                size="lg"
                className="group bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white px-10 py-6 text-lg font-bold rounded-2xl shadow-2xl shadow-cyan-500/25 hover:shadow-purple-500/25 transform hover:scale-105 transition-all duration-500 border-0"
              >
                <Link href="/register">
              ...
              {admitCardEnabled && (
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="group border-2 border-cyan-500 text-cyan-600 dark:text-cyan-400 hover:bg-cyan-50 dark:hover:bg-cyan-900/20 px-10 py-6 text-lg font-bold rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              {[
                ...
                <div
                  key={index}
                  className="group bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl p-8 shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-500 border border-white/20 dark:border-slate-700/20 hover:border-cyan-400/50"
                  style={{ animationDelay: `${index * 200}ms` }}
                >
                  <div
                    className={`bg-gradient-to-r ${stat.color} w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:rotate-12 transition-transform duration-500`}
                  >
          ...
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
            <button
              ...
              className="group text-cyan-500 hover:text-purple-500 transition-all duration-500 animate-bounce-slow"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            {[
              ...
              <Card
                key={index}
                className="group bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border-0 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 rounded-3xl overflow-hidden"
              >
                <CardContent className="p-10 text-center relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-transparent to-slate-50/50 dark:to-slate-900/50 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <div
                    className={`bg-gradient-to-r ${item.gradient} w-20 h-20 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg`}
                  >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {OLYMPIAD_PHOTOS.map((photo, index) => (
              <div key={photo.id} className="group relative cursor-pointer" onClick={() => setCurrentPhotoIndex(index)}>
                <div className="relative h-48 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500">
                  <Image
      ...
      <section id="details" className="py-32">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-10">
              {[
                ...
                <div key={index} className="flex items-start gap-6 group">
                  <div
                    className={`bg-gradient-to-r ${item.gradient} w-16 h-16 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 shadow-lg`}
                  >
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-cyan-500 via-purple-500 to-pink-500 rounded-3xl p-10 text-white shadow-2xl transform hover:scale-105 transition-all duration-500 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <Button
                    asChild
                    className="w-full mt-8 bg-white text-purple-600 hover:bg-gray-100 font-bold py-4 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500"
                  >
                    <Link href="/register">
                ...
                <CardContent className="p-10 relative">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-6 mb-6">
                      <div
                        className={`bg-gradient-to-r ${contact.gradient} w-16 h-16 rounded-2xl flex items-center justify-center group-hover:rotate-12 transition-transform duration-500`}
                      >
          ...
          <div className="text-center mt-16">
            ...
            <div className="flex justify-center gap-8">
              <Link
                ...
                className="group bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-500"
              >
                <svg
              ...
              <Link
                ...
                className="group bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white p-6 rounded-2xl shadow-xl hover:shadow-2xl transform hover:scale-110 transition-all duration-500"
              >
                <svg
                  className="h-8 w-8 group-hover:scale-110 transition-transform"
                  fill="currentColor"
