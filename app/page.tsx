          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <Button
                    asChild
                    size="lg"
                    // We remove padding from the Button component itself to avoid style conflicts.
                    className="p-0"
                  >
                    <Link
                      href="/register"
                      style={{
                        // The reflection gradient's opacity has been significantly reduced (from 0.7 to 0.25).
                        // This makes the reflection much fainter, removing the hard "box shade" effect.
                        WebkitBoxReflect: 'below 0px linear-gradient(to bottom, rgba(0,0,0,0.0), rgba(0,0,0,0.25))',
                      }}
                      // The main link container. A substantial margin-bottom (mb-20) has been added.
                      // This provides ample space for the reflection to render without being cropped,
                      // especially during the scaling animation on hover.
                      className="inline-block group cursor-pointer mb-20"
                    >
                      <div
                        // This inner div handles all visual styling and animations.
                        // The `text-transparent` class has been removed to allow the child text to be visible.
                        className="px-10 py-6 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full shadow-xl group-hover:shadow-2xl group-hover:shadow-purple-500/30 shadow-cyan-500/30 uppercase font-serif tracking-widest relative overflow-hidden z-10 hover:saturate-[1.15] active:saturate-[1.4] transform group-hover:scale-105 transition-all duration-300 border-0"
                      >
                        {/* This visually hidden span helps define the button's size based on its content. */}
                        <span className="opacity-0">Launch Registration</span>
                        
                        {/* First animated text layer ("Launch"). The text is now solid black. */}
                        <p
                          className="absolute z-40 font-semibold text-black top-1/2 left-1/2 -translate-x-1/2 h-full w-full transition-all duration-300 -translate-y-1/2 group-hover:-translate-y-[150%] tracking-widest flex items-center justify-center"
                        >
                          Launch
                        </p>
                        
                        {/* Second animated text layer ("Registration"). The text is now solid black. */}
                        <p
                          className="absolute z-40 top-1/2 left-1/2 text-black -translate-x-1/2 h-full w-full transition-all duration-300 translate-y-[150%] group-hover:-translate-y-1/2 tracking-widest font-extrabold flex items-center justify-center"
                        >
                          Registration
                        </p>
                        
                        {/* SVG for the background wave animation. */}
                        <svg
                        ...
                        >
                          <defs>
                            {/* The SVG gradient has been updated to the new cyan-to-purple theme. */}
